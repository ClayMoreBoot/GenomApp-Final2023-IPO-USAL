...
class AnimalWidget extends StatefulWidget {
  const AnimalWidget({
    ...
    required this.imagenscanner,
    required this.genomas,
    required this.despliegues,
    required this.especcies,
  })  : this.imagen = imagen ?? '',
        super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 0.0, 24.0),
